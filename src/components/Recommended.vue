<script setup>
    ...
    onBeforeMount(() => {
        axios.get('https://dummyjson.com/products?limit=8&skip=45')
            .then(res => {
                recommendedProducts.value = res.data.products
            })
    })
</script>
...
<template>
    <div class="container pb-16">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div v-for="product,index in recommendedProducts" :key="index" class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
                    <img :src="product.thumbnail" style="height:294px !important;width: 294px !important" :alt="product.title" class="w-full">
                ...
                <div class="pt-4 pb-3 px-4">
                    <a href="#">
                        <h4 class="uppercase font-medium text-sm mb-2 text-gray-800 hover:text-primary transition">{{ product.title }}</h4>
                    </a>
